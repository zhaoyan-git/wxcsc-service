    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['iot:projectPointGroup']"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            const structureId = this.$route.params && this.$route.params.structureId;

            if (projectId) {
                this.queryParams.projectId = projectId;
            }
            if (structureId && 0 != structureId) {
                this.queryParams.structureId = structureId;
            }
