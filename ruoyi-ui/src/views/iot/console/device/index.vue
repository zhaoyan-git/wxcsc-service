<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否报警" prop="alarmFlag">
        <el-input
      ...
      <el-form-item label="设备在地图上的纬度" prop="positionLat">
        <el-input
          v-model="queryParams.positionLat"
          placeholder="请输入设备在地图上的纬度"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="设备在地图上的经度" prop="positionLng">
        <el-input
          v-model="queryParams.positionLng"
          placeholder="请输入设备在地图上的经度"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="deviceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="设备在地图上的经度" align="center" prop="id" />
      ...
      <el-table-column label="设备图片" align="center" prop="photoFile" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="handleDeleteWxcxcDeviceSensor">删除</el-button>
          </el-col>
        </el-row>
        <el-table :data="wxcxcDeviceSensorList" :row-class-name="rowWxcxcDeviceSensorIndex" @selection-change="handleWxcxcDeviceSensorSelectionChange" ref="wxcxcDeviceSensor">
          ...
          <el-table-column label="传感器图标" prop="iconFile">
            <template slot-scope="scope">
              <el-input v-model="scope.row.iconFile" placeholder="请输入传感器图标" />
            </template>
          </el-table-column>
          ...
          <el-table-column label="传感器类型" prop="type">
            <template slot-scope="scope">
              <el-input v-model="scope.row.type" placeholder="请输入传感器类型" />
            </template>
          </el-table-column>
