<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['iot:projectPoint:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['iot:projectPoint:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['iot:projectPoint:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="projectPointList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="监测因素所需数据" align="center" prop="id" />
      <el-table-column label="名称" align="center" prop="name" />
      <el-table-column label="图片地址" align="center" prop="photoFile" />
      <el-table-column label="所属结构物" align="center" prop="projectStructureId" />
      <el-table-column label="所属分组" align="center" prop="pointGroupId" />
      ...
      <el-table-column label="监测因素" align="center" prop="monitorType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.iot_monitor_type" :value="scope.row.monitorType"/>
        </template>
      </el-table-column>
      <el-table-column label="监测因素所需数据" align="center" prop="monitorData" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属结构物" prop="projectStructureId">
          <el-select v-model="form.projectStructureId" placeholder="请选择所属结构物">
            <el-option label="请选择字典生成" value="" />
          </el-select>
        </el-form-item>
        <el-form-item label="所属分组" prop="pointGroupId">
...
<script>
import { listProjectPoint, getProjectPoint, delProjectPoint, addProjectPoint, updateProjectPoint, exportProjectPoint } from "@/api/iot/projectPoint";
