  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="所属企业" prop="businessId">
        <el-select v-model="queryParams.businessId" placeholder="请选择所属企业" clearable size="small">
    ...
    <el-table v-loading="loading" :data="projectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="所属企业" align="center" prop="businessId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属企业" prop="businessId">
          <el-select v-model="form.businessId" placeholder="请选择所属企业">
            <el-option label="请选择字典生成" value="" />
          </el-select>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$modal.confirm('是否确认导出所有项目数据项？').then(() => {
