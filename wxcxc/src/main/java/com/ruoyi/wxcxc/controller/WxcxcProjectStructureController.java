...
public class WxcxcProjectStructureController extends BaseController
{
     ...
     * 查询项目结构物列表
     */
    @PreAuthorize("@ss.hasPermi('iot:projectStructure:list')")
    @GetMapping("/list")
     ...
     * 导出项目结构物列表
     */
    @PreAuthorize("@ss.hasPermi('iot:projectStructure:export')")
     ...
     * 获取项目结构物详细信息
     */
    @PreAuthorize("@ss.hasPermi('iot:projectStructure:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增项目结构物
     */
    @PreAuthorize("@ss.hasPermi('iot:projectStructure:add')")
     ...
     * 修改项目结构物
     */
    @PreAuthorize("@ss.hasPermi('iot:projectStructure:edit')")
     ...
     * 删除项目结构物
     */
    @PreAuthorize("@ss.hasPermi('iot:projectStructure:remove')")
